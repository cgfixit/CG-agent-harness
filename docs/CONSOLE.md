...
| Analytics | `/analytics` opens retained tokens/cost, sessions and coding-run outcomes with pagination and completeness warnings. [Interpretation and API](ANALYTICS.md). |
